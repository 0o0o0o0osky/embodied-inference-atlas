...
it('opens both measured cases with their own implementation, stable trace and independent counters',()=>{
  ...
  for (const [runId,runtime,chunk,signature,formula] of [
    ['run-pi0-realtime-vla-w5-r10-001','realtime-vla',50,'kernel-signature-pi0-realtime-vla-gate-up-fusion-017','Gate Up 融合计算'],
    ['run-pi0-flashrt-fixed-e2e-001','flashrt',10,'kernel-signature-pi0-flashrt-geglu-fp8-028','GEGLU 与 FP8 转换'],
  ] as const) {

...
it("keeps the full Pi0 profiler register behind the Kernel summary", () => {
  ...
  expect(summary.slice(0, summary.indexOf("<details"))).toContain("NCU · Kernel 诊断");
  expect(summary.slice(0, summary.indexOf("<details"))).not.toContain("Kernel 热点 Top 3");
  expect(summary).toContain("pi0-ncu-focus");
  expect(summary).toContain("单次回放");
  expect(summary).toContain("pi0-ncu-bar-row");
